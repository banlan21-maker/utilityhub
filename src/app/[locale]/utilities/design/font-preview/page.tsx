...
const faqSchema = {
  ...
  "@type": "FAQPage",
  "mainEntity": [
    { "@type": "Question", "name": "구글 폰트는 무료로 사용할 수 있나요?", "acceptedAnswer": { "@type": "Answer", "text": "네. Google Fonts에 등록된 모든 폰트는 SIL Open Font License 또는 Apache License로 제공되어 개인·상업적 용도 모두 무료로 사용할 수 있습니다. 별도 저작권 표기도 필요하지 않습니다." } },
    { "@type": "Question", "name": "폰트를 불러오는 속도가 너무 느립니다", "acceptedAnswer": { "@type": "Answer", "text": "이 도구는 IntersectionObserver를 이용해 화면에 보이는 카드의 폰트만 레이지 로드합니다. 한 번 로드된 폰트는 캐시되어 재방문 시 즉시 표시됩니다. 느린 경우 브라우저 캐시를 지우거나 네트워크 환경을 확인하세요." } },
    { "@type": "Question", "name": "눈누(NoonNU) 폰트도 지원되나요?", "acceptedAnswer": { "@type": "Answer", "text": "현재는 Google Fonts를 통해 제공되는 한국어 폰트를 지원합니다. 눈누 전용 폰트는 향후 업데이트에서 추가할 예정입니다. 필요한 폰트가 있으면 피드백 게시판에 남겨주세요." } },
