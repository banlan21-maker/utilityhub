...
const faqSchema = {
  ...
  "@type": "FAQPage",
  "mainEntity": [
    { "@type": "Question", "name": "WCAG AA와 AAA 기준의 차이는 무엇인가요?", "acceptedAnswer": { "@type": "Answer", "text": "AA는 대부분의 웹사이트에서 요구되는 최소 기준입니다. 일반 텍스트 4.5:1, 큰 텍스트 3:1 이상이 필요합니다. AAA는 더 엄격한 향상된 기준으로, 일반 텍스트 7:1, 큰 텍스트 4.5:1이 필요합니다. 대부분의 프로젝트는 AA 충족을 목표로 합니다." } },
    { "@type": "Question", "name": "색맹 사용자를 위한 색상 선택 팁이 있나요?", "acceptedAnswer": { "@type": "Answer", "text": "빨강-초록(적록색맹)과 파랑-노랑(청황색맹) 조합은 피하세요. 색상만으로 정보를 전달하지 말고 아이콘, 패턴, 텍스트를 함께 사용하세요. 대비비 4.5:1 이상을 유지하면 색맹 사용자에게도 대부분 읽기 쉽습니다." } },
    { "@type": "Question", "name": "HEX 코드 없이 색상을 입력할 수 있나요?", "acceptedAnswer": { "@type": "Answer", "text": "현재는 HEX 코드 입력과 색상 피커를 지원합니다. rgb(255,255,255) 형식은 직접 지원하지 않으므로, RGB to HEX 변환 후 입력하거나 색상 피커를 사용하세요." } },
      ...
      <SeoSection
        ko={{
          ...
          steps: [
            ...
            { step: '결과 공유 & 디자인 적용', desc: '합격 배지 결과를 스크린샷으로 팀에게 공유하거나, 확인된 색상 조합을 디자인 시스템 문서에 기록하여 브랜드 가이드라인으로 활용하세요.' },
          ],
          faqs: [
        ...
        en={{
          ...
          steps: [
            ...
            { step: 'Share results & apply to design', desc: 'Screenshot the pass/fail badges to share with your team, or record the verified color combinations in your design system documentation for use as brand guidelines.' },
          ],
          faqs: [
