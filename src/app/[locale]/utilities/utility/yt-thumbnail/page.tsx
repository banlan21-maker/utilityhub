...
const faqSchema = {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "유튜브 썸네일을 추출하는 것이 저작권법에 위반되지 않나요?",
      "acceptedAnswer": { "@type": "Answer", "text": "썸네일의 저작권은 영상을 업로드한 크리에이터에게 있습니다. 개인적인 학습·분석·참고 목적으로 저장하는 것은 일반적으로 허용되나, 상업적 용도로 사용하거나 무단 배포 시에는 저작권자의 동의가 반드시 필요합니다." }
    },
    {
      "@type": "Question",
      "name": "MaxRes(1280×720) 썸네일이 나타나지 않아요.",
      "acceptedAnswer": { "@type": "Answer", "text": "모든 유튜브 영상에 MaxRes 썸네일이 존재하지는 않습니다. 업로드 해상도가 낮은 영상이나 오래된 영상은 SD 또는 HQ가 최고 화질일 수 있습니다." }
    },
    {
      "@type": "Question",
      "name": "유튜브 쇼츠(Shorts)나 재생목록 썸네일도 추출할 수 있나요?",
      "acceptedAnswer": { "@type": "Answer", "text": "유튜브 쇼츠는 일반 영상과 동일한 형식의 ID를 사용하므로 추출 가능합니다. 단, 재생목록·채널 아트·커뮤니티 탭 이미지는 현재 지원하지 않습니다." }
    },
    {
      "@type": "Question",
