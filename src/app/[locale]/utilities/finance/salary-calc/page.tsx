        ...
        <SeoSection
          ko={{
            ...
            faqs: [
              ...
              { q: '미국 FICA+연방세 22%는 어떻게 계산된 건가요?', a: 'FICA 7.65%(사회보장세 6.2% + 메디케어 1.45%)에 표준 공제를 적용한 연방소득세 추정치 약 14.35%를 합산한 값입니다. 실제 세율은 연봉 수준, 거주 주(State), 개인 공제 항목에 따라 크게 달라질 수 있으니 IRS 세율표나 공인 회계사에 확인하세요.' },
            ],
          }}
          en={{
            ...
            faqs: [
              ...
              { q: 'Why is the US FICA+Federal estimate 22%?', a: 'FICA is 7.65% (Social Security 6.2% + Medicare 1.45%). The remaining ~14.35% estimates typical federal income tax after the standard deduction for a moderate-income worker. Actual tax varies significantly by income bracket, state of residence, and personal deductions — consult a tax professional or IRS tables for precision.' },
            ],
          }}
        />
      </div>
