...
export async function generateMetadata({
  ...
  const title = isKo
    ? "부가가치세(VAT) 계산기 | Utility Hub"
    : "VAT Calculator | Utility Hub";
  const description = isKo
    ? "공급가액과 부가세를 즉시 계산하세요. 한국 10% 기본 세율, 역산 모드 지원."
    : "Instantly calculate VAT amounts. Add or extract VAT with multiple global tax rates.";
  const canonical = `https://www.theutilhub.com/${params.locale}/utilities/finance/vat-calc`;
