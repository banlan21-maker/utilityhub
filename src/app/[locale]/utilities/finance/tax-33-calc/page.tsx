...
export async function generateMetadata({
  ...
  const title = isKo
    ? "프리랜서 3.3% 원천징수 계산기 | Utility Hub"
    : "Freelancer 3.3% Withholding Tax Calculator | Utility Hub";
  const description = isKo
    ? "프리랜서 계약금에서 3.3% 원천징수 후 실수령액을 즉시 계산하세요. 4대보험 포함 옵션 지원."
    : "Instantly calculate 3.3% withholding tax deduction and net income for Korean freelancers.";
  const canonical = `https://www.theutilhub.com/${params.locale}/utilities/finance/tax-33-calc`;
