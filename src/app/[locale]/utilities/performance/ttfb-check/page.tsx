...
const faqSchema = {
  ...
  "@type": "FAQPage",
  "mainEntity": [
    { "@type": "Question", "name": "TTFB는 몇 ms 이하여야 좋은 건가요?", "acceptedAnswer": { "@type": "Answer", "text": "구글 권장 기준: 200ms 이하는 '양호(Good)', 200~500ms는 '보통(Needs Improvement)', 500ms 초과는 '개선 필요(Poor)'입니다. 국내 서버 기준 100ms 이하가 이상적입니다." } },
    { "@type": "Question", "name": "TTFB가 높을 때 원인과 해결책은 무엇인가요?", "acceptedAnswer": { "@type": "Answer", "text": "주요 원인: 서버 처리 속도 저하, 느린 데이터베이스 쿼리, CDN 미사용, 높은 서버 부하입니다. 해결책: CDN 도입, 서버 캐싱 적용, 데이터베이스 쿼리 최적화, 더 빠른 호스팅으로 이전을 고려하세요." } },
    { "@type": "Question", "name": "매번 측정 결과가 조금씩 다른 이유는 무엇인가요?", "acceptedAnswer": { "@type": "Answer", "text": "네트워크 경로, 서버 부하, DNS 조회 시간 등이 매 요청마다 달라질 수 있습니다. 동일한 URL을 3~5회 반복 측정해 평균값을 기준으로 판단하는 것을 권장합니다." } },
