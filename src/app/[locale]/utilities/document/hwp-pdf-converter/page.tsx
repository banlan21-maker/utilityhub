...
const softwareSchema = {
  ...
  description:
    'HWP(한글) 및 HWPX 파일을 PDF 또는 Word(DOCX)로 변환하는 무료 온라인 도구입니다. 한컴오피스가 설치되지 않은 맥, 리눅스, 스마트폰에서도 즉시 사용할 수 있습니다.',
};
...
const faqSchema = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: 'HWP와 HWPX 중 어느 형식이 더 잘 변환되나요?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'HWPX 형식이 훨씬 정확하게 변환됩니다. HWPX는 국제 표준 XML 기반이라 구조 파악이 용이하고, HWP(바이너리)는 레거시 형식이라 일부 요소가 다르게 표현될 수 있습니다. 한컴오피스 2014 이상에서 "다른 이름으로 저장 → HWPX"로 먼저 변환 후 업로드를 권장합니다.',
      },
    },
    {
      '@type': 'Question',
      name: '변환된 PDF에서 글꼴이 깨집니다',
      acceptedAnswer: {
        '@type': 'Answer',
        text: '서버에 설치된 폰트와 원본 문서에서 사용한 폰트가 다를 경우 대체 폰트로 표시됩니다. 주요 한글 폰트(맑은 고딕, 나눔고딕 등)는 기본 지원되며, 특수 폰트는 깨질 수 있습니다.',
      },
    },
    {
      '@type': 'Question',
      name: '업로드한 파일은 서버에 저장되나요?',
      acceptedAnswer: {
        '@type': 'Answer',
        text: '변환에 사용된 파일은 처리 후 즉시 삭제되며 서버에 보관되지 않습니다. 개인정보가 포함된 중요 문서도 안심하고 변환하실 수 있습니다.',
      },
    },
    {
      '@type': 'Question',
      ...
      <SeoSection
        ko={{
          ...
          steps: [
            ...
            { step: '변환 대기', desc: '버튼 클릭 즉시 변환이 시작됩니다. 파일 크기에 따라 수 초에서 수십 초가 소요될 수 있습니다. 변환 중에는 버튼이 비활성화됩니다.' },
            { step: '파일 다운로드', desc: '변환 완료 후 파일이 자동으로 다운로드됩니다. 브라우저의 기본 다운로드 폴더에 저장되며, 원본 파일명을 유지한 채 확장자만 변경됩니다.' },
          ],
          faqs: [
            ...
            { q: '변환된 PDF에서 글꼴이 깨지거나 다르게 보입니다', a: '서버에 설치된 폰트와 원본 문서에서 사용한 폰트가 다를 경우 대체 폰트로 표시됩니다. 주요 한글 폰트(맑은 고딕, 나눔고딕 등)는 기본 지원되며, HCR 바탕·HCR 돋움 등 한컴 전용 폰트는 깨질 수 있습니다. 이 경우 HWPX로 먼저 변환 후 업로드하면 개선될 수 있습니다.' },
        ...
        en={{
          ...
          steps: [
            ...
            { step: 'Download your file', desc: 'The converted file downloads automatically to your browser\'s default downloads folder. The original filename is preserved with only the extension changed.' },
          ],
          faqs: [
