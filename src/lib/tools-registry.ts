...
export const tools: Tool[] = [
  ...
  { slug: 'core-web-vitals', category: 'performance', emoji: '📐', labelKey: 'PerformanceBoard.core-web-vitals.title', href: '/utilities/performance/core-web-vitals', available: true },
  ...
  { slug: 'ac-capacity-calc', category: 'lifestyle', emoji: '❄️', labelKey: 'LifestyleBoard.ac-capacity-calc.title', href: '/utilities/lifestyle/ac-capacity-calc', available: true },
  ...
  { slug: 'wire-size-calc', category: 'utility', emoji: '⚡', labelKey: 'UtilityBoard.wire-size-calc.title', href: '/utilities/utility/wire-size-calc', available: true },
  { slug: 'interior-material-calc', category: 'utility', emoji: '🪟', labelKey: 'UtilityBoard.interior-material-calc.title', href: '/utilities/utility/interior-material-calc', available: true },
